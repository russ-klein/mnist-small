   ...
   static const int layer1_unit_offset_factor   = 2;  
   static const int later1_unit_count           = 8;  
      
   static const int layer1_weight_offset           = 0;  
   static const int layer2_weight_offset        = layer1_weight_offset + 16;  
   ...
   static const int layer2_unit_offset_factor   = 2;  
   static const int later2_unit_count           = 24;  
      
   static const int layer3_weight_offset        = layer2_weight_offset + 48;  
   ...
   static const int layer3_unit_offset_factor = 471;  
   static const int later3_unit_count         = 10;  
      
   static const int layer4_weight_offset      = layer3_weight_offset + 4710;  
   ...
   static const int   top_of_weights            = 4774; 
