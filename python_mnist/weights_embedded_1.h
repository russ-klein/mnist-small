   ...
   static const int layer1_unit_offset_factor   = 9;  
   static const int later1_unit_count           = 8;  
      
   static const int layer1_weight_offset           = 0;  
   static const int layer2_weight_offset        = layer1_weight_offset + 72;  
   ...
   static const int layer2_unit_offset_factor   = 9;  
   static const int later2_unit_count           = 24;  
      
   static const int layer3_weight_offset        = layer2_weight_offset + 216;  
   ...
   static const int layer3_unit_offset_factor = 2352;  
   static const int later3_unit_count         = 10;  
      
   static const int layer4_weight_offset      = layer3_weight_offset + 23520;  
   ...
   static const int   top_of_weights            = 23808; 
