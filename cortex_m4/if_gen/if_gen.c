...
static void print_intro(FILE *txt, signal_struct *signals)
{
    ...
    fprintf(txt, "  input          clock,                                                \n");
    fprintf(txt, "  input          resetn,                                               \n");
    fprintf(txt, "  input  [1:0]   trans,                                                \n");
    fprintf(txt, "  input  [29:0]  address,                                              \n");
    fprintf(txt, "  input  [3:0]   bl,                                                   \n");
    fprintf(txt, "  input          we,                                                   \n");
    fprintf(txt, "  input          ce,                                                   \n");
    fprintf(txt, "  input  [31:0]  write_data,                                           \n");
    fprintf(txt, "  output [31:0]  read_data,                                            \n");
    fprintf(txt, "  output [1:0]   resp,                                                 \n");
    if (master) {
...
//        fprintf(txt, "  input  [1:0]   hruser                                                \n");
    ...
    fprintf(txt, "                                                                       \n");
    fprintf(txt, " reg     [15:0]  write_address;                                        \n");
    fprintf(txt, " wire    [15:0]  read_address;                                         \n");
    fprintf(txt, " reg     [15:0]  read_address_delayed;                                 \n");
    fprintf(txt, " reg             write_enable;                                         \n");
    fprintf(txt, " wire            read_enable;                                          \n");
    fprintf(txt, " reg             read_enable_delayed;                                  \n");
    fprintf(txt, "                                                                       \n");
    fprintf(txt, " wire            ready_out;                                            \n");
    fprintf(txt, " reg             resp_out = 2'b00;                                     \n");
    fprintf(txt, "                                                                       \n");
    fprintf(txt, " always @(posedge clock or negedge resetn) begin                       \n");
    fprintf(txt, "   if (resetn == 1'b0) begin                                           \n");
    fprintf(txt, "     write_address <= 32'h00000000;                                    \n");
    fprintf(txt, "     write_enable  <= 1'b0;                                            \n");
    fprintf(txt, "   end else begin                                                      \n");
    fprintf(txt, "     write_address <= address[15:0];                                   \n");
    fprintf(txt, "     write_enable  <= we & ce;                                         \n");
    fprintf(txt, "   end                                                                 \n");
    fprintf(txt, " end                                                                   \n");
    fprintf(txt, "                                                                       \n");
    fprintf(txt, " ready_gen #(1) rg (clock, resetn, ce, trans, ready_out);              \n");
    fprintf(txt, "                                                                       \n");
    fprintf(txt, " assign ready     = ready_out;                                         \n");
    fprintf(txt, " assign resp      = resp_out;                                          \n");
    fprintf(txt, " assign read_data = rd_reg;                                            \n");
    fprintf(txt, " assign read_address = address[15:0];                                  \n");
    fprintf(txt, "                                                                       \n");
}
...
static void print_signals(FILE *txt, signal_struct *signals)
{
    ...
    if (master) {
        ...
        fprintf(txt, " always @(posedge clock or negedge resetn) begin              \n");
        fprintf(txt, "    if (resetn == 1'b0) begin                                 \n");
        fprintf(txt, "      input_master_raddr_delayed <= 32'h00000000;             \n");
        fprintf(txt, "      input_master_rrdy_delayed <= 1'b0;                      \n");
        fprintf(txt, "      input_master_re_delayed <= 1'b0;                        \n");
        fprintf(txt, "      output_master_wrdy_delayed <= 1'b0;                     \n");
        fprintf(txt, "      read_data_active <= 1'b0;                               \n");
        fprintf(txt, "      write_data_active <= 1'b0;                              \n");
        fprintf(txt, "    end else begin                                            \n");
...
static void print_register_accesses(FILE *txt, signal_struct *signals)
{
    ...
    fprintf(txt, "                                                                       \n");
    fprintf(txt, " assign read_enable = ce & !we;                                        \n");
    fprintf(txt, "                                                                       \n");
    fprintf(txt, " always @(posedge clock) read_enable_delayed <= read_enable;           \n");
    fprintf(txt, " always @(posedge clock) read_address_delayed <= read_address;         \n");
    fprintf(txt, "                                                                       \n");
    fprintf(txt, " always @(posedge clock or negedge resetn) begin                       \n");
    fprintf(txt, "   if (resetn == 1'b0) begin                                           \n");
    ...
    while (sp) {
        if (sp->is_channel) {
            if (sp->is_input) {
                ...
                fprintf(txt, "    end else begin \n");
                fprintf(txt, "       if (write_enable & ready_out) begin \n");
                ...
                fprintf(txt, "    end else begin \n");
                fprintf(txt, "       if (read_enable_delayed & ready_out) begin \n");
                fprintf(txt, "          if (read_address_delayed == `%s) begin \n", uppercase(sp->signal_name, buf));
...
static void print_header_file(FILE *txt, signal_struct *signals)
{
    ...
    fprintf(txt, " ***************************************************************************/\n");
    fprintf(txt, "   \n");
    fprintf(txt, "#define ACCEL_ADDR ((volatile unsigned long *) 0xA0000000) \n");
    fprintf(txt, "   \n");
    fprintf(txt, "   \n");
    fprintf(txt, "// register map \n");
    fprintf(txt, "   \n");
