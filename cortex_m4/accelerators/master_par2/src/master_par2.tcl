...
solution options set /Input/CompilerFlags {-I ../../../../python_mnist -DSYNTHESIS -DMASTER -DHOST -DWEIGHT_MEMORY -DFIXED_POINT -DPAR_IN=2 -DM3 }
...
directive set /conv_par_in/core/output_image_pr_mem -WORD_WIDTH 32
directive set /conv_par_in/core/output_image_mem -WORD_WIDTH 32
directive set /conv_par_in/core/input_image_mem -WORD_WIDTH 32
